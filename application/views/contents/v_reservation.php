					...
					<form class="mt-5">
							<div class="row">
								<div class="col">
									...
									<div class="form-group">
										...
										<div class="row">
											...
											<div class="col pl-2">
												...
												<div class="form-group">
													<select id="nationality" name="nationality" class="form-control" placeholder="Select your nationality">
													<option value="" disabled selected hidden>Select your nationality</option>
									...
									<!--trip story-->
									<div class="form-group">
										<textarea class="form-control" name="story" placeholder="Explain about your trip" rows="5"></textarea>
									</div>
